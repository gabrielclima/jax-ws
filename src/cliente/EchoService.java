 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://controller/", wsdlLocation = "http://localhost:10000/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://controller/", "EchoService");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://controller/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controller/", "EchoPort"), Echo.class, features);
    }
